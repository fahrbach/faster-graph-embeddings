...
if __name__ == "__main__":
    ...
    parser.add_argument("--subsetfile",type=str,default=None,
            help="the reverse map file for taking a subset for evaluation")        
    ...
    if args.subsetfile is not None:
        print("reading mapping from ", args.subsetfile)    
        map = np.loadtxt(args.subsetfile,dtype=int,skiprows=1)
        #print(map.dtype)
        label = label[map,:]
